...
test("index page renders correctly", async ({ page }) => {
  ...
  await expect(page).toHaveTitle("Ynda Jas (she/they)");
...
test("Nihongo page renders correctly", async ({ page }) => {
  ...
  await expect(page).toHaveTitle("Nihongo - Ynda Jas (she/they)");
...
test("writing page renders correctly", async ({ page }) => {
  ...
  await expect(page).toHaveTitle("Writing - Ynda Jas (she/they)");
